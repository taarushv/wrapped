        ...
        return (
            ...
            >
                <header className={s.logo}>
                    <a href="https://wrapped.com" target="_blank">Wrapped  <span
                        className="fw-bold">TokenSoft</span></a>
                </header>
                <ul className={s.nav}>
                    <LinksGroup
                        ...
                        index="main"
                    />
                    <h5 className={[s.navTitle, s.groupTitle].join(' ')}>Pages</h5>
                    <LinksGroup
                        onActiveSidebarItemChange={activeItem => this.props.dispatch(changeActiveSidebarItem(activeItem))}
                        activeItem={this.props.activeItem}
                        header="Transfers"
