...
import Mints from '../../pages/mints/Mints'
import Trades from '../../pages/trades/Trades'
import ProofOfReserves from '../../pages/proof-of-reserves/ProofOfReserves'
              ...
              <TransitionGroup>
                ...
                >
                  <Switch>
                    ...
                    <Route path="/app/transfers" exact component={Transfers} />
                    <Route path="/app/mints" exact component={Mints} />
                    <Route path="/app/trades" exact component={Trades}/>
                    <Route path="/app/proof-of-reserves" exact component={ProofOfReserves}/>
                  </Switch>
                </CSSTransition>
              </TransitionGroup>
              <footer className={s.contentFooter}>
                2020 <a href="https://wrapped.com" >Wrapped</a>
              </footer>
            </main>
          </Hammer>
        </div>
